                                                ...
                                                <div class="col">
                                                    ...
                                                    <span class="size-guide" style="float: left;">
                                                        ...
                                                        <?php } else if (get_field('model_type', $post_id) == '8-speed') {?>
                                                            ...
                                                            - Normal € 1499<br><br>
                                                        <?php } ?>
                                                        Buy at Indiegogo May 1st. Save up to 53%
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <?php
                        ...
                        if(get_option_tree($i.'_slider_top_text_e_model') == 'Size') {
                            if(get_field('size', $post_id) == '20') {
                                $src = 'https://movea.bike/wp-content/uploads/2018/03/size-bike-custom.jpg';
                            } else {
                                $src = 'https://movea.bike/wp-content/uploads/2018/03/size-bike-custom-1.jpg';
                            }
                        }
                    ?>
